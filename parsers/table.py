    ...
    def get_privacy(self, tag_list):
        ...
        for i in range(0, len(tag_list)):
            ...
            if tag.name == 'h2':
                ...
                if is_method_section and "Member Function Documentation" not in des_text:
                    is_method_section = False
                ...
                for j in range(i + 1, len(tag_list)):
                    ...
                    if next_tag.name == 'td' and 'class' in next_tag.attrs.keys() and 'memname' in next_tag.attrs['class']:
                        if j + 1 >= len(tag_list):
                            break
                        api_name = next_tag.getText().split(".")[-1].strip()
                        ...
                        # self.apis.append(api_name)
                        # api_names.add(api_name)
                        api2signature[api_name] = next_tag.getText()
